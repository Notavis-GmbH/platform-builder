...
classDiagram
    note "Opticus App"
    WebAppBlob <|-- WebApp
    WebAppEdgeDetection <|-- WebApp

    note for WebAppBlob "Blobdetection for demo purpose"
    WebApp : +int age
    WebApp : +String gender
    WebApp: +isMammal()
    WebApp: +mate()
    class WebAppBlob{
        +String beakColor
...
<ol>
 <li>Connect the module to the ethernet. A direct connection or over a switch/router is possible</li>
